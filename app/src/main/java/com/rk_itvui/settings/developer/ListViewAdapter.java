...
//		Log.d("ListViewAdapter","getCount(), name = "+name);
	...
	public String getContent()
	{
		...
		switch(mIndicator)
		{
			case SettingMacroDefine.DEVELOPMENT:
				name = "development";
				break;
...
//		Log.d("ListViewAdapter","getView() position = "+position);
		...
		if(item.getStatus() != null)
		{
			...
			text.setTextSize(mContext.getResources().getDimension(R.dimen.setting_list_size)
		...
		if(item.getSummary() != null)
		{
			...
			text.setTextSize(mContext.getResources().getDimension(R.dimen.setting_list_size));//(ScreenInformation.mScreenWidth/60f*ScreenInformation.mDpiRatio);
		}
		...
		if(id != -1)
		{
			...
			textview.setTextSize(mContext.getResources().getDimension(R.dimen.setting_list_size));//(ScreenInformation.mScreenWidth/40f*ScreenInformation.mDpiRatio);
