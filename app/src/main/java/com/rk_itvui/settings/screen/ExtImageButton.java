...
public class ExtImageButton extends ImageButton {
    ...
    public ExtImageButton(Context context, AttributeSet attrs) {
        ...
        _color = a.getColor(R.styleable.ExtImageButton_textColorz,  
                0XFFFFFFFF);  
        _textsize = a.getDimension(R.styleable.ExtImageButton_textSizez, 50);  
          
        _text = a.getString(R.styleable.ExtImageButton_textz)==null?"":a.getString(R.styleable.ExtImageButton_textz);
